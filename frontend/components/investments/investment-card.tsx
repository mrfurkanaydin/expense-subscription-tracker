...
import type { Investment, MarketPrice, InvestmentType } from "@/lib/types/investments";
import {
...
export function InvestmentCard({
    ...
    const currentPriceTRY = convertToTRY(currentPrice, marketPrice?.currency || investment.purchase_currency);
    const purchasePriceTRY = convertToTRY(investment.purchase_price, investment.purchase_currency);
                    ...
                    <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                                <span className="text-lg">{INVESTMENT_TYPE_ICONS[investment.type as InvestmentType]}</span>
                            ...
                            <div className="flex items-center gap-4 text-xs text-muted-foreground">
                                <span>
                                    Miktar: <span className="font-medium text-foreground">{investment.quantity}</span>
                                </span>
                                <span>
                                    Alış: <span className="font-medium text-foreground">{formatCurrency(investment.purchase_price, investment.purchase_currency)}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="text-right flex-shrink-0">
                            <p className="text-xs text-muted-foreground mb-0.5">Güncel Değer</p>
