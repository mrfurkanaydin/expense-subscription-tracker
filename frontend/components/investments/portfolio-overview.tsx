...
import type { Investment, PortfolioSummary, InvestmentType } from "@/lib/types/investments";
import { INVESTMENT_TYPE_COLORS, INVESTMENT_TYPE_LABELS, INVESTMENT_TYPE_ICONS } from "@/lib/types/investments";
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="pt-2 border-t border-border">
                            <p className="text-xs text-muted-foreground">
                                Toplam Maliyet: <span className="font-medium text-foreground">{formatCurrency(summary.totalCost, "TRY")}</span>
                            </p>
                        </div>
                    </div>
                                ...
                                <div key={item.type} className="flex items-center justify-between text-sm">
                                    <div className="flex items-center gap-2">
                                        <div
                                            ...
                                            style={{ backgroundColor: INVESTMENT_TYPE_COLORS[item.type] }}
                                        />
                                        <span className="text-muted-foreground">
                                            {INVESTMENT_TYPE_ICONS[item.type]} {INVESTMENT_TYPE_LABELS[item.type]}
                                        </span>
                                    </div>
