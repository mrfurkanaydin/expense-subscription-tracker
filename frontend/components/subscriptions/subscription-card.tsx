...
export function SubscriptionCard({
  ...
  const nextBillingDate = calculateNextPayment(
            ...
            <div
              className={cn(
                ...
                isActive
                  ...
                  : "from-gray-800 to-gray-900 text-gray-500"
              )}
            >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <span>{isActive ? "Sonraki Ödeme" : "Bitiş Tarihi"}</span>
            </div>
            <div
              className={cn(
              ...
              <span>
                {formatDate(
                  isActive
                    ...
                    : subscription.end_date || subscription.next_billing_at
                )}
              </span>
            </div>
          </div>
